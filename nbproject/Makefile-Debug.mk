...
${OBJECTDIR}/src/nctime.o: src/nctime.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nctime.o src/nctime.c

${OBJECTDIR}/src/rewrite-scalar.o: src/rewrite-scalar.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/rewrite-scalar.o src/rewrite-scalar.c

${OBJECTDIR}/src/ncdump.o: src/ncdump.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ncdump.o src/ncdump.c

${OBJECTDIR}/src/indent.o: src/indent.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/indent.o src/indent.c

${OBJECTDIR}/src/vardata.o: src/vardata.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/vardata.o src/vardata.c

${OBJECTDIR}/src/nciter.o: src/nciter.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nciter.o src/nciter.c

${OBJECTDIR}/src/dumplib.o: src/dumplib.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/dumplib.o src/dumplib.c

${OBJECTDIR}/src/ncdump-original.o: src/ncdump-original.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ncdump-original.o src/ncdump-original.c
